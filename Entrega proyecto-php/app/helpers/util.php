...
function numeroFormateado($num)
{
    ...
    // $directorio =  $_SERVER['DOCUMENT_ROOT'] .'EjeMockaroo-CRUD/app/uploads';

    // $rutacompleta = $directorio . '/'.'0000' . $var . ".jpg";

    // if (file_exists($rutacompleta)) {
    //     return "0000" . $var . ".jpg";
    // } else {
    //     return "https://robohash.org/" . $var;
    // }


    //   DEBUG:
        // if(is_dir($directorio)){
        //     return "https://i.ytimg.com/vi/d3pcXM5wfvA/maxresdefault.jpg";
        // }else{
        //     return "https://thumbs.dreamstime.com/b/dog-puppy-breed-dachshund-shoulder-boy-teenager-his-pet-sad-281326267.jpg";
        // }
        ...
        // $directorio = "C:\\xampp\\htdocs\\php\\EjeMockaroo-CRUD\\images"; 
